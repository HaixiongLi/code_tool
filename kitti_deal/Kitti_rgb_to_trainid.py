...
dir = '/Users/lihaixiong/Documents/Python/semantic_tmp/FCN_Kitti-master/Dataset/semantic_image/training/semantic_rgb/'
save_dir = '/Users/lihaixiong/Documents/Python/semantic_tmp/FCN_Kitti-master/Dataset/semantic_image/training/rgb2trainid/'
...
for i in range(len(Img_number_dir)):
    ...
    plt.imsave(dir+Img_number_dir[i],aa)
