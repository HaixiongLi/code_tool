...
dir = './Dataset/semantic_image/training/semantic_rgb/'
save_dir = './Dataset/semantic_image/training/train_npy/'
...
for i in range(len(Img_number_dir)):
    ...
    np.save(save_dir+Img_number_dir[i][:(len(Img_number_dir[i])-4)], label_matrix)
